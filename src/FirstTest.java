...
public class FirstTest {
    ...
    public void testSaveTwoArticlesInFolder()
    {
        ...
        String article_title_expected = waitForElementAndGetAttribute(
                By.id("org.wikipedia:id/view_page_title_text" ),
                "text",
                "Cannot find title of article",
                10);
        ...
        waitForElementNotPresent(By.xpath("//*[@text='JavaScript'] "),
                "Cannot delete saved article",
                5
        );
        ...
        String article_title_actual = waitForElementAndGetAttribute(
                By.id("org.wikipedia:id/view_page_title_text"),
                "text",
                "Cannot find title of article",
                10);
       ...
       Assert.assertEquals("Article title doesn't match",
    ...
    protected void swipeElmentToLeft(By by, String error_message)
    {
